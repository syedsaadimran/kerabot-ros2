"""
Launch file for Robot_to_URDF_New_Pakka.

Usage:
    ros2 launch Robot_to_URDF_New_Pakka_description display.launch.py
    ros2 launch Robot_to_URDF_New_Pakka_description display.launch.py namespace:=robot1
"""
...
def generate_launch_description():
    pkg_dir = get_package_share_directory('Robot_to_URDF_New_Pakka_description')

    xacro_file = os.path.join(pkg_dir, 'urdf', 'Robot_to_URDF_New_Pakka.urdf.xacro')
